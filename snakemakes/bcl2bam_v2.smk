...
#TODO: set barcodes mismatches on the fly?!        
checkpoint extract_fastqs:
    ...
    shell:
        ...
        {params.binary} {params.rl} --create-fastq-for-index-reads -R {params.bclpath} -w 0 -r {threads} -p {threads} -o $bn --sample-sheet {params.samplesheet} --fastq-compression-level 9 2> {log}
        """
